...
- Take a look into each script and check what it's designed for and on what it depends on (for example, I mostly use XFS as file system, therefore xfsdump is used by the script). Each script is small in size and as simple as possible.
